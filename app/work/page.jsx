...
const projects = [
  ...
  },
  {
    ...
    title: "project 2",
    description:
      "An integrated project showcasing frontend rendering, styling, and backend functionality for a cohesive user experience.",
  ...
  },
  {
    ...
    title: "project 3",
    description:
      "Utilized modern tools for frontend rendering and styling to create a dynamic user interface.",
              ...
              <div className="flex items-center gap-4">
                  ...
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-black/5 flex justify-center items-center group">
                        <BsArrowUpRight className="text-black text text-3xl group-hover:text-accent" />
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Live Project</p>
                      </TooltipContent>
                ...
                <Link href={project.github}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-black/5 flex justify-center items-center group">
                        <BsGithub className="text-black text text-3xl group-hover:text-accent" />
                      </TooltipTrigger>
                      <TooltipContent>
              ...
              {projects.map((project, index) => {
                return (
                  <SwiperSlide key={index} className="w-full">
                    <div className="h-[460px] relative group flex justify-center items-center bg-orange-400/20">
                      {/* overlay */}
